		...
		<div id="main">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-list"></i>实景展示编辑</h3>
							</div>
								...
								<form action="#" method="POST" class='form-horizontal form-column'>
									<div class="span12">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="title" id="title" placeholder="" class="input-xlarge" style="width: 560px;" value="<?php echo htmlspecialchars( $productShow->title ); ?>">
											</div>
										</div>
										<div class="control-group">
											<label for="image" class="control-label">图片</label>
											<div class="controls">
												<input type="text" name="image" id="image" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $productShow->image ); ?>">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="orderid" id="orderid" placeholder="默认255，顺序相同按时间倒序。" class="input-xlarge" value="<?php echo htmlspecialchars( $productShow->order ); ?>">
											</div>
										</div>
									</div>
									<div class="span12">
										<div class="form-actions">
											...
											<input type="hidden" name="id" value="<?php echo $productShow->id; ?>">
										</div>
									</div>
								</form>
							</div>
