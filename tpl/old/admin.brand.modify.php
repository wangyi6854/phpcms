		...
		<div id="main">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-list"></i>品牌故事编辑</h3>
							</div>
								...
								<form action="#" method="POST" class='form-horizontal form-column'>
									<div class="span12">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="title" id="title" placeholder="" class="input-xlarge" style="width: 560px;" value="<?php echo htmlspecialchars( $brand->title ); ?>">
											</div>
										</div>
										<div class="control-group">
											<label for="image" class="control-label">标题图</label>
											<div class="controls">
												<input type="text" name="image" id="image" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $brand->image ); ?>">
												<input type="button" value="上传" id="upload_btn" />
											</div>
										</div>
										<div class="control-group">
											<label for="postdate" class="control-label">显示顺序</label>
											<div class="controls">
												<input type="text" name="order" id="order" placeholder="默认255，顺序相同按时间倒序。" class="input-xlarge" value="<?php echo htmlspecialchars( $brand->order ); ?>">
											</div>
										</div>
<!--
										<div class="control-group">
											...
											<div class="controls">
												<textarea name="summary" id="summary" rows="5" class="input-block-level"><?php echo htmlspecialchars( $brand->summary ); ?></textarea>
											</div>
										</div>
										<div class="control-group">
