								...
								<table class="table table-nomargin table-striped">
									<thead>
										<tr>
											...
											<th style="width: 100px;">被举报人姓名</th>
											<th style="text-align: center;">举报线索</th>
...
?>
										<tr>
											...
											<td><a href="./?module=admin.jubao.modify&id=<?php echo $job[ 'id' ]; ?>" class="view_detail" data-toggle="modal">详情</a></td>
											<td><a href="./?module=admin.jubao.delete&id=<?php echo $job[ 'id' ]; ?>" class="delete_job">删除</a></td>
										</tr>
<?php
}
?>
