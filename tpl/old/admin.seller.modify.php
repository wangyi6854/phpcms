		...
		<div id="main">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-list"></i>经销商编辑</h3>
							</div>
							<div class="box-content nopadding">
								<form action="#" method="POST" class='form-horizontal form-column'>
									<div class="span12">
										<div class="control-group">
											<label for="yxs" class="control-label">经销商名称</label>
											<div class="controls">
												<input type="text" name="yxs" id="yxs" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $seller->name ); ?>">
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="fax" id="fax" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $seller->fax ); ?>">
											</div>
										</div>
										<div class="control-group">
