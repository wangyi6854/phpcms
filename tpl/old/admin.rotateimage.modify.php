		...
		<div id="main">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-list"></i>图片编辑</h3>
							</div>
								...
								<form action="#" method="POST" class='form-horizontal form-column'>
									<div class="span6">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="photo" id="photo" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $product->photo ); ?>">
												<input type="button" value="上传" class="upload_btn" tag="photo" />
												(1900x500)
											</div>
										</div>
									</div>
