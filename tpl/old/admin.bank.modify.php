		...
		<div id="main">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-list"></i>银行编辑</h3>
							</div>
								...
								<form action="#" method="POST" class='form-horizontal form-column'>
									<div class="span12">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="name" id="name" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $bank->name ); ?>">
											</div>
										</div>
										<div class="control-group">
											<label for="username" class="control-label">用户名</label>
											<div class="controls">
												<span><?php echo htmlspecialchars( $bank->username ); ?></span>
											</div>
										</div>
										<div class="control-group">
											<label for="password" class="control-label">密码</label>
											<div class="controls">
												<input type="text" name="password" id="password" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $bank->password ? $bank->password : gen_password() ); ?>">
											</div>
										</div>
										<div class="control-group">
											<label for="abbr" class="control-label">简写</label>
											<div class="controls">
												<input type="text" name="abbr" id="abbr" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $bank->abbr ); ?>">
											</div>
										</div>
										<div class="control-group">
											<label for="logo" class="control-label">logo</label>
											<div class="controls">
												<input type="text" name="logo" id="logo" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $bank->logo ); ?>">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="small_logo" id="small_logo" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $bank->small_logo ); ?>">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="order" id="order" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $bank->order ); ?>">
												(越小越靠前)
											</div>
										</div>
									</div>
