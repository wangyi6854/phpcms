		...
		<div id="main">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-list"></i>荣誉证书编辑</h3>
							</div>
								...
								<form action="#" method="POST" class='form-horizontal form-column'>
									<div class="span6">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="title" id="title" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $award->title ); ?>">
											</div>
										</div>
										<div class="control-group">
											<label for="image" class="control-label">图片</label>
											<div class="controls">
												<input type="text" name="image" id="image" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $award->image ); ?>">
												<input type="button" value="上传" class="upload_btn" tag="image" />
												图片尺寸不要超过1500x1500
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="thumb" id="thumb" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $award->thumb ); ?>">
												<input type="button" value="上传" class="upload_btn" tag="thumb" />
												图片尺寸为200x150
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="orderid" id="orderid" placeholder="默认255。越小越靠前。" class="input-xlarge" value="<?php echo htmlspecialchars( $award->order ); ?>">
											</div>
										</div>
									</div>
									<div class="span12">
