						...
						<div class="box">
							<div class="box-title">
								<h3>
									...
									法院列表
									<a style="font-size: smaller;"a href="./?module=admin.court.modify">添加法院</a>
								</h3>
							...
							<div class="box-content nopadding">
								<table class="table table-nomargin table-striped">
									...
									<tbody>
<?php
foreach ( $list->list as $court )
{
?>
										<tr>
											<td><?php echo $court->id; ?></td>
											<td><?php echo $court->order; ?></td>
											<td><?php echo $court->name; ?></td>
											<td><a href="./?module=admin.court.modify&id=<?php echo $court->id; ?>">修改</a></td>
											<td><a href="./?module=admin.court.delete&id=<?php echo $court->id; ?>" class="delete_court">删除</a></td>
										</tr>
<?php
}
?>
