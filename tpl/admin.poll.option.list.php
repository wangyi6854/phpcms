						...
						<div class="box">
							<div class="box-title">
								<h3>
									...
									投票项目管理
									[<a href="./?module=admin.poll.option.modify&poll_id=<?php echo $id; ?>" style="font-size: smaller;">添加</a>]
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </h3>
...
?>
										<tr>
                                            ...
                                            <td><?php echo $news->count; ?></td>
                                            <td><?php echo $news->status; ?></td>
											<td><a href="./?module=admin.poll.option.modify&id=<?php echo $news->id; ?>">修改</a></td>
											<td><a href="./?module=admin.poll.option.delete&id=<?php echo $news->id; ?>" class="delete_news">删除</a></td>
										</tr>
<?php
}
?>
