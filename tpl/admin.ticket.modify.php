		...
		<div id="main">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-list"></i>演出编辑</h3>
							</div>
								...
								<form action="#" method="POST" class='form-horizontal form-column'>
									<div class="span12">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="address" id="address" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $news->address ); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <label for="start" class="control-label">演出时间</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <label for="num" class="control-label">每人票数（短信显示）</label>
                                            <div class="controls">
                                                <input type="text" name="num" id="num" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $news->num ); ?>">
                                            </div>
                                        </div>
										...
										-->
										<div class="control-group">
											<label for="titleImage" class="control-label">logo</label>
											<div class="controls">
												<input type="text" name="image" id="titleImage" placeholder="" class="input-xlarge" value="<?php echo htmlspecialchars( $news->image ); ?>">
