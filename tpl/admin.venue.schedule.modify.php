		...
		<div id="main">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-list"></i>场所编辑</h3>
							</div>
							<div class="box-content nopadding">
								<form action="#" method="POST" class='form-horizontal form-column'>
									<div class="span12">
                                        ...
                                        <div class="control-group">
                                            <label for="periodFrom" class="control-label"> 时间段</label>
                                            <div class="controls">
                                                <input type="text" name="periodFrom" id="periodFrom" placeholder="" class="input-xlarge" style="width: 40px;" value="<?php echo htmlspecialchars( date( 'H:i', strtotime( $news->periodFrom ) ) ); ?>"> -
                                                <input type="text" name="periodTo" id="periodTo" placeholder="" class="input-xlarge" style="width: 40px;" value="<?php echo htmlspecialchars( date( 'H:i', strtotime( $news->periodTo ) ) ); ?>">
                                                格式：9:30
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                {
                                                    ?>
                                                    <label><input type="checkbox" name="week[]" value="<?php echo $i; ?>" <?php if ( strpos( $news->week, $i ) !== false ) echo 'checked'; ?>><?php echo htmlspecialchars( $i ); ?></label>
                                                    <?php
                                                }
                                                ?>
                                            </div>
                                        ...
                                        <div class="control-group">
                                            <label for="validFrom" class="control-label">有效期开始</label>
                                            <div class="controls">
                                                <input type="text" name="validFrom" id="validFrom" placeholder="" class="input-xlarge" style="width: 560px;" value="<?php echo htmlspecialchars( $news->validFrom ); ?>">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="validEnd" class="control-label">有效期结束</label>
                                            <div class="controls">
                                                <input type="text" name="validEnd" id="validEnd" placeholder="" class="input-xlarge" style="width: 560px;" value="<?php echo htmlspecialchars( $news->validEnd ); ?>">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="maxCount" class="control-label">人数限制</label>
                                            <div class="controls">
