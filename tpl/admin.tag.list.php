            ...
            <div class="card">
                ...
                foreach ( $list->list as $news )
                {
                    ...
                    <tr>
                        ...
                        <td><a href="" target="_blank"><?php echo $news->name; ?></a></td>
                        <td></td>
                        <td><a href="./?module=admin.tag&id=<?php echo $news->id; ?>">修改</a></td>
                        <td><a href="./?module=admin.tag.delete&id=<?php echo $news->id; ?>" class="delete_news">删除</a></td>
                    </tr>
                    <?php
                }
                ?>
