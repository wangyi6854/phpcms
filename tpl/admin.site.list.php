						...
						<div class="box">
							<div class="box-title">
								<h3>
									...
									场地管理
									[<a href="./?module=admin.site.modify; ?>" style="font-size: smaller;">添加</a>]
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</h3>
...
?>
										<tr>
											...
											<td><a href="./?module=admin.site.modify&id=<?php echo $news->id; ?>">修改</a></td>
											<td><a href="./?module=admin.site.delete&id=<?php echo $news->id; ?>" class="delete_news">删除</a></td>
										</tr>
<?php
}
?>
